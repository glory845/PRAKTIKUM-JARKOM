...
2. Menghapus cache pada browser yang akan digunakan agar proses permintaan DNS dimulai dari awal.
![browser cache](../assets/image/4.9.png)
3. Ketik perintah **ipconfig** untuk mengetahui alamat IP laptop kita.
![alamat IP](../assets/image/4.10.png)
4. Buka aplikasi wireshark dan pilih jaringan yang digunakan.
5. Masukkan filter **ip.addr == [Masukkan_IP_Kamu]** untuk menyaring lalu lintas data.
![filter](../assets/image/4.12.png)
6. Tekan tombol Start Capture pada Wireshark untuk mulai merekam lalu lintas jaringan.
7. Buka browser dan kunjungi alamat **http://www.ietf.org**.
